 ...
 * time : 2015-11-30
 */
define(['jquery','custom','tooltip','hoverintent','wysiwyg','jqui','superfish','highcharts','pop'],function($){
    /**
...
// Once DOM (document) is finished loading
    $(function() {
        ...
        $('#J_generateLink').on('click',function(){
            var _html = '<div class="generateLink"><div class="linkInput">推广链接：<input type="text" value="'+_link+'" /></div><div class="Qrcode"><img src="http://bshare.optimix.asia/barCode?site=weixin&url=' + _link + '" alt="二维码"></div>只有通过此链接或者二维码下单才有钱哦！</div>';
            $popUpBox.init({
                html:_html,
                close:true
            });
