    ...
    public function replaceScreen()
    {
        return $data = array(
            ...
            '0' => array(
                'phone_id'=>129,
                'name'=>'iPhone7',
                'outside'  => array('id'=>'1544','price'=>'648','name'=>'外屏碎裂'),
                'inner'  => array('id'=>'1545','price'=>'1500','name'=>'内屏异常'),
            ),
            '1' => array(
                'phone_id'=>130,
                'name' => 'iPhone7 plus',
                'outside'  => array('id'=>'1549','price'=>'699','name'=>'外屏碎裂'),
                'inner'  => array('id'=>'1550','price'=>'1700','name'=>'内屏异常'),
            ),
            '2' => array(
                'phone_id'=>67,
                'name'=>'iPhone6s',
                'outside'  => array('id'=>'1005','price'=>'360','name'=>'外屏碎裂'),
                'inner'  => array('id'=>'943','price'=>'746','name'=>'内屏异常'),
            ),
            '3' => array(
                'phone_id'=>68,
                'name' => 'iPhone6s plus',
                'outside'  => array('id'=>'942','price'=>'399','name'=>'外屏碎裂'),
