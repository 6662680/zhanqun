...
require_once(VENDOR_PATH . "alipay/alipay_core.function.php");
require_once(VENDOR_PATH . "alipay/alipay_md5.function.php");
...
class AlipaySubmit {
	...
	function buildRequestUrl($para_temp) {
		...
		$url = $this->alipay_gateway_new . $this->buildRequestParaToString($para_temp);
		return $url;
	}
